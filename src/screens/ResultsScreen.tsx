...
export default function ResultsScreen() {
  ...
  const handleSaveMeasurement = () => {
    const measured = parseFloat(actualMeasured);
    if (!isNaN(measured) && measured > 0) {
      const variance = measured - calculation.results.recommendedCamber;
  ...
  const variance = calculation.variance !== undefined 
    ...
    : calculation.actualMeasuredCamber !== undefined
      ? calculation.actualMeasuredCamber - calculation.results.recommendedCamber
      : undefined;
        ...
        <View className="p-5">
          ...
          <View className="bg-white rounded-xl p-5 mb-5 shadow-sm">
            ...
            <Text className="text-sm text-gray-600 mb-3">
              Enter the actual measured camber from the field:
            </Text>
            
            <View className="flex-row gap-3 mb-3">
              <TextInput
                className="flex-1 bg-gray-50 border border-gray-300 rounded-xl px-4 py-3 text-base text-gray-900"
            ...
            {calculation.actualMeasuredCamber !== undefined && variance !== undefined && (
              <View className="bg-gray-50 rounded-lg p-3">
                ...
                <View className="flex-row justify-between mb-2">
                  <Text className="text-sm text-gray-700">Recommended:</Text>
                  <Text className="text-sm font-semibold text-gray-900">
                    {formatInchesWithFraction(calculation.results.recommendedCamber)}
                  </Text>
                </View>
          ...
          <View className="bg-white rounded-xl p-5 mb-5 shadow-sm">
            ...
            {!calculation.inputs.strandPattern && (
              <View style={{ height: 0 }} />
            )}
          </View>
