...
• Measured Camber at Release: ${results.netInitialCamber.toFixed(3)} in
            ...
            <View className="bg-blue-50 rounded-lg p-3 mb-3 border-2 border-blue-200">
              <View className="flex-row items-center justify-between">
                ...
                <Text className="text-lg font-bold text-blue-900">
                  {calculation.results.netInitialCamber.toFixed(3)} <Text className="text-sm text-blue-700">in</Text>
                </Text>
              </View>
            </View>
