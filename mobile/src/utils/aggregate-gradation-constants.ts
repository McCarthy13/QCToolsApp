...
export const DEFAULT_AGGREGATES: Record<string, AggregateConfig> = {
  'Keystone #7': {
    type: 'Coarse',
    sieves: [
      { name: '1"', size: 25.0, weightRetained: '', c33Lower: 100, c33Upper: 100 },
      { name: '3/4"', size: 19.0, weightRetained: '', c33Lower: 90, c33Upper: 100 },
      { name: '1/2"', size: 12.5, weightRetained: '', c33Lower: '-', c33Upper: '-' },
      { name: '3/8"', size: 9.5, weightRetained: '', c33Lower: 20, c33Upper: 55 },
      { name: '#4', size: 4.75, weightRetained: '', c33Lower: 0, c33Upper: 10 },
      { name: '#8', size: 2.36, weightRetained: '', c33Lower: 0, c33Upper: 5 },
      { name: '#16', size: 1.18, weightRetained: '', c33Lower: '-', c33Upper: '-' },
      { name: '#30', size: 0.6, weightRetained: '', c33Lower: '-', c33Upper: '-' },
      { name: '#50', size: 0.3, weightRetained: '', c33Lower: '-', c33Upper: '-' },
      { name: '#100', size: 0.15, weightRetained: '', c33Lower: '-', c33Upper: '-' },
      { name: '#200', size: 0.075, weightRetained: '', c33Lower: '-', c33Upper: '-' },
  ...
  'Kraemer 9/16"': {
    ...
    sieves: [
      { name: '1"', size: 25.0, weightRetained: '', c33Lower: 100, c33Upper: 100 },
      { name: '3/4"', size: 19.0, weightRetained: '', c33Lower: 100, c33Upper: 100 },
      { name: '1/2"', size: 12.5, weightRetained: '', c33Lower: 85, c33Upper: 100 },
      { name: '3/8"', size: 9.5, weightRetained: '', c33Lower: 10, c33Upper: 30 },
      { name: '#4', size: 4.75, weightRetained: '', c33Lower: 0, c33Upper: 10 },
      { name: '#8', size: 2.36, weightRetained: '', c33Lower: 0, c33Upper: 5 },
      { name: '#16', size: 1.18, weightRetained: '', c33Lower: '-', c33Upper: '-' },
      { name: '#30', size: 0.6, weightRetained: '', c33Lower: '-', c33Upper: '-' },
  ...
  'Concrete Sand': {
    ...
    sieves: [
      ...
      { name: '#50', size: 0.3, weightRetained: '', c33Lower: 5, c33Upper: 30 },
      { name: '#100', size: 0.15, weightRetained: '', c33Lower: 0, c33Upper: 10 },
      { name: '#200', size: 0.075, weightRetained: '', c33Lower: 0, c33Upper: 3 },
      { name: 'Pan', size: 0, weightRetained: '', c33Lower: '-', c33Upper: '-' },
    ],
  },
};
